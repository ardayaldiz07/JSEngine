...
class Player extends GameObject {
    constructor(name, x, y, w, h, c, useGravity, useCollision) {
        ...
        // Küplerin hepsi aynı yöne gitmesin diye rastgele yön ve hız veriyoruz (1 ile 3 arası hız)
    ...
    update() {
        ...
        // Ekran sınırlarına çarpma kontrolü (Taşmaları önlemek için this.w ve this.h kullandım)
        if (this.x >= 600 - this.w) {
            this.x = 600 - this.w; // Duvarın içine girmesini engelle
            this.velX = -this.velX;
        } else if (this.x <= 0) {
            this.x = 0;
            this.velX = -this.velX;
